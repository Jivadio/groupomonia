      ...
      <div class="mt-10">
        <form method="post" @submit.prevent="login">
          <div class="flex flex-col mb-5">
            ...
            <div class="relative">
              ...
              <input id="pseudo" type="text" name="pseudo" class="
                    text-sm
                  ...
                  " placeholder="Entrez votre pseudonyme" v-model="pseudo" />
            </div>
          </div>
        ...
        <div class="flex justify-center items-center mt-6">
          <span class="
            ...
            text-xs text-center
          ">
            <span class="ml-2">Pas encore de compte ?
              <NuxtLink to="register"><span class="text-xs ml-2 text-blue-500 font-semibold">Inscription</span>
              </NuxtLink>
            </span>
          </span>
        </div>
