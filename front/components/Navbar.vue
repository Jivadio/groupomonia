        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:block">
                <ul class="flex space-x-8 text-sm font-sans">
                    <li><NuxtLink to="/" class="border-b-2 border-blue-500 pb-1">Acceuil</NuxtLink></li>
                    <li><NuxtLink to="/" href="#" class="">Services</NuxtLink></li>
                    <li><NuxtLink to="/" href="#"
            ...
            <aside
                ...
                <ul class="divide-y font-sans">
                    ...
                    <li><a href="#" @click="isOpen = false"
                            class="my-8 w-full text-center font-semibold cta inline-block bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white">Sign
                            Up</a></li>
                </ul>
